...
public abstract class BaseApiEntity extends BaseEntity {
    ...
    public static final int                 ERROR_CODE_SESSTION_TIMOUT             = 1001;
    public static final int                 FAILED_CODE_SESSION_TIMEOUT            = 1001;
    public static final int                 FAILED_CODE_PARA_WANTEDTOKEN                = 1101;                     // 缺少令牌参数
    // 会话超时
    // 会话超时
    public static final int                 FAILED_CODE_PARA_TOKEN_MISMATCH             = 1102;                     // 令牌不匹配
    ...
    static {
        ...
        ERROR_DESCS.put(FAILED_CODE_PARA_TOKEN_MISMATCH, "令牌不匹配");
        ERROR_DESCS.put(FAILED_CODE_PARA_WANTEDTOKEN, "未登录");//缺少令牌参数
