...
/**
 * 使用{@code AsyncTask}源码，仅仅修改了{@link #execute(Runnable)} 和{@link #execute(Object[])} 方法<br>
 * Detail to see  {@link AsyncTask}
 */
public abstract class LocalAsyncTask<Params, Progress, Result> {
     ...
     */
    public final LocalAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     */
    public final LocalAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
        Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final LocalAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(LocalAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
